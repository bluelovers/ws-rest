 ...
 */
export declare function expandRfc6570<M extends IExpandDataInput = IExpandDataInput, K extends keyof M = keyof M>(url: string, data: M): {
    paths: Pick<M, K>;
    data: Omit<M, K>;
    router: string;
    url: string;
...
export declare function expandRouter<M extends IExpandDataInput = IExpandDataInput, K extends keyof M = keyof M>(url: string, data: M): {
    paths: Pick<M, K>;
    data: Omit<M, K>;
    router: string;
    url: string;

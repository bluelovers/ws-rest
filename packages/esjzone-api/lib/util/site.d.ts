...
export declare function _getBookInfo($: JQueryStatic, data: Pick<IESJzoneRecentUpdateRowBook, 'name' | 'titles' | 'authors' | 'last_update_time'>): Pick<IESJzoneRecentUpdateRowBook, "last_update_time" | "name" | "titles" | "authors">;
